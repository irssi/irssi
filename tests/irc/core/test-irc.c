...
static void test_event_get_params(void)
{
	...
	struct test_case const tests[] = {
		...
		},
		{
			...
			.input       = "#test +o :tester",
			.output0     = "#test",
			/* TODO: This is a problem fixed by PR #766 */
			.output1     = "+o :tester",
		},
		{
		...
		{
			.description = "Channel mode with three parameters after channel name, : inside a param",
			.input       = "#test +ov te:ster tester2 hi:there",
			.output0     = "#test",
			.output1     = "+ov te:ster tester2 hi:there",
		},
		{
			.description = "Channel mode with three parameters after channel name, : inside a param followed by a <trailing>",
			.input       = "#test +ov te:ster :tester2 hi:there",
			.output0     = "#test",
			/* TODO: This is a problem fixed by PR #766 */
			.output1     = "+ov te:ster :tester2 hi:there",
		...
		{
			.description = "Channel mode with three parameters after channel name, : inside a param followed by a <trailing>, extra spaces",
			.input       = "#test  +ov  te:ster  :tester2  hi:there",
			.output0     = "#test",
			/* TODO: This is a problem fixed by PR #766 */
			.output1     = " +ov  te:ster  :tester2  hi:there",
