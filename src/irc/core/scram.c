...
static int process_client_first(scram_session *session, char **output, size_t *output_len)
{
...
static int process_server_final(scram_session *session, const char *data)
{
	char *verifier;
